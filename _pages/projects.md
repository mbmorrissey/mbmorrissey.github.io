...
If I have a coherent research theme, it is theory and methods methods for quantifying natural selection.  Here are a few key outputs from this area (see also [publications](/_pages/publications.md)):
